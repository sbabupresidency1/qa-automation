...
/**
 * This class contains all application level constants
 *
...
public class ApplicationConstants {
	...
	public static final String GECKO_DRIVER_PATH_MAC = "src/main/resources/drivers/geckodriver";
	public static final String GECKO_DRIVER_PATH_WINDOWS = "src/main/resources/drivers/geckodriver.exe";
	public static final String GECKO_DRIVER_PATH_LINUX="src/main/resources/drivers/geckodriver";
	public static final String CHROME_DRIVER_PATH_LINUX="src/main/resources/drivers/chromedriver";
}
