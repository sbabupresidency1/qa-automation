package com.zillion.qa.listeners;
...
import com.zillion.qa.exceptions.ZadoReporterStepFailedException;
import com.zillion.qa.utils.Attributes;
import com.zillion.qa.utils.Directory;
import com.zillion.qa.utils.Platform;
import com.zillion.qa.utils.SettingsFile;
import com.zillion.qa.utils.TestParameters;
import com.zillion.qa.writers.ConsolidatedReportsPageWriter;
import com.zillion.qa.writers.CurrentRunPageWriter;
import com.zillion.qa.writers.HTMLDesignFilesJSWriter;
import com.zillion.qa.writers.IndexPageWriter;
import com.zillion.qa.writers.TestCaseReportsPageWriter;

public class ZadoReportsListener implements ITestListener, IExecutionListener, IReporter, ISuiteListener {

	static Logger log = Logger.getLogger(ZadoReportsListener.class.getName());
	int runCount = 0;
	...
	public void onTestSuccess(ITestResult result)  {
		try
		{
			...
			{
				result.setStatus(2);
				result.setThrowable(new ZadoReporterStepFailedException());
	...
	public static void setPlatfromBrowserDetails(ITestResult paramITestResult)  {
		Platform.prepareDetails(ZadoReports.getWebDriver());
	...
	public void generateIndexPage()  {
		...
		try
		{
			...
			IndexPageWriter.content(localPrintWriter, ZadoReports.indexPageDescription);
